...
(() => {
  ...
  window.Webflow ||= [];
  window.Webflow.push(() => {
    const postList = document.querySelector('[cs-el="postList"]');
    ...
    const nextButton = document.querySelector('[cs-el="nextPost"]');
    const previousButton = document.querySelector('[cs-el="previousPost"]');
