...
(() => {
  ...
  var gsapEaseType = "power2.out";
  var gsapDuration = 0.5;
  ...
  window.Webflow ||= [];
  window.Webflow.push(() => {
    const reviewStars = document.querySelectorAll('[cs-el="reviewStars"]');
    ...
    if (faqs) {
      faqs.forEach((faq) => {
        ...
        faq.addEventListener("click", (event) => {
          const activeFaq = event.currentTarget;
          const openFaq = document.querySelector(".is-open");
          const openFaqAnswer = openFaq?.querySelector('[cs-el="faq-answer"]');
          const openFaqQuestion = openFaq?.querySelector('[cs-el="faq-question"]');
          console.log();
